...
define('dummy/config/environment', ['ember'], function(Ember) {
  return { 'default': {"modulePrefix":"dummy","environment":"development","baseURL":"/","locationType":"auto","EmberENV":{"FEATURES":{}},"APP":{"name":"ember-power-select","version":"0.10.0-beta.8+c90b8b1a"},"ember-cli-mirage":{"enabled":false,"usingProxy":false,"useDefaultPassthroughs":true},"something":"test","exportApplicationGlobal":true}};
});
...
if (!runningTests) {
  require("dummy/app")["default"].create({"name":"ember-power-select","version":"0.10.0-beta.8+c90b8b1a"});
}
